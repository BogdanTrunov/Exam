...
namespace Lessons{
    ...
    class Program{
        ...
        public static double Lab_Task8_1B_Var2(double arg1, double arg2) {
            function_result = Math.Pow(arg2, 2) + Math.Pow(arg1, 2) + 5 * arg1 * arg2 + 78;
            return function_result;
        }

        static double Lab_Task8_2A_and_B_Var9(double arg1)
        {
            function_result = 2 / arg1;
            return function_result;
        }
        ...
        static void Main(string[] args){
            while (exit_program) {
                ...
                Console.WriteLine("6. ЛР, задание 8.2a, вариант 9");
                Console.WriteLine("7. ЛР, задание 8.2б, вариант 9");
                ...
                switch (count) {
                    ...
                    case 5:
                        ...
                        for (Cycle_Count = 0; Cycle_Count < N; Cycle_Count++) {
                            ...
                            F = Lab_Task8_1B_Var2(mas[Cycle_Count], y);
                            Console.WriteLine("Значение массива в X" + Cycle_Count + "= " + mas[Cycle_Count] + " F= " + F);
                       }
                        break;
                    case 6:
                        Console.WriteLine("Вы выбрали ЛР, задание 8.2a, вариант 9, смотрите: ");
                        x = 4;
                        Console.WriteLine("Введите число N: ");
                        N = int.Parse(Console.ReadLine());
                        for (Cycle_Count = 1; Cycle_Count <= N; Cycle_Count++) {
                            if (Cycle_Count % 2 == 1)
                            {
                                result = result + (-1) * Lab_Task8_2A_and_B_Var9(x);
                            }
                            else {
                                result = result + Lab_Task8_2A_and_B_Var9(x);
                            }
                            Console.WriteLine("Сумма ряда: " + result + " При значении модуля слагаемого " + Lab_Task8_2A_and_B_Var9(x));
                            x = x + 3;
                        }
                        break;
                    case 7:
                        Console.WriteLine("Вы выбрали ЛР, задание 8.2б, вариант 9, смотрите: ");
                        x = 4;
                        Console.WriteLine("Введите число e: ");
                        e = double.Parse(Console.ReadLine());
                        for (Cycle_Count = 1; Math.Abs(Lab_Task8_2A_and_B_Var9(x) - Last_Slog) >= e; Cycle_Count++)
                        {
                            if (Cycle_Count % 2 == 1)
                            {
                                result = result + (-1) * Lab_Task8_2A_and_B_Var9(x);
                            ...
                            Console.WriteLine("Сумма ряда: " + result + " При значении модуля слагаемого " + Lab_Task8_2A_and_B_Var9(x));
                            Last_Slog = Lab_Task8_2A_and_B_Var9(x);
                            x = x + 3;
                        }
                        Console.WriteLine("Количество итераций: " + Cycle_Count);
                        break;
                }
                if (count == 0){
                    exit_program = false;
